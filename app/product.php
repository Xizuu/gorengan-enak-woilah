  ...
  <div class="flex-1 flex flex-col p-6 space-y-6 ml-0 sm:ml-56 w-full">
    ...
    >
      <div class="flex items-center justify-between mb-4">
        <h2 class="text-white font-semibold text-base">Daftar Produk</h2>
        <a type="button" href="/produk/add" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold rounded-lg transition">
          + Tambah Data
        </a>
      </div>
              ...
              <tr class="border-b border-gray-800 hover:bg-gray-800 transition">
                ...
                <td class="px-4 py-3">
                  <?= !empty($product["gambar"])
                    ? '<img width="80px" height="80px" src="data:image/png;base64,' . htmlspecialchars($product["gambar"]) . '" alt="Gambar" />'
                    : "Tidak ada foto" ?>
                </td>
                <td class="px-4 py-3">
                  <p>Rp <?= htmlspecialchars(number_format($product["harga"])) ?></p>
                </td>  
                <td class="px-4 py-3 space-x-2">
                  <a type="button" href="/produk/edit?id=<?= $product["id"] ?>" class="px-3 py-1 rounded-lg bg-blue-500 text-white text-xs font-semibold hover:bg-blue-600 transition">Edit</a>
                  <a type="button" href="/produk/delete?id=<?= $product["id"] ?>" class="px-3 py-1 rounded-lg bg-red-500 text-white text-xs font-semibold hover:bg-red-600 transition">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
